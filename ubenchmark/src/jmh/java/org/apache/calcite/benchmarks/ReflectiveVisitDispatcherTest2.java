...
import org.apache.calcite.util.ReflectUtilUsingHashMapReflectiveVisitorDispatcher;
...
public class ReflectiveVisitDispatcherTest2 {

  private ReflectiveVisitor visitor = new People();

  @Param({ "0", "128" })
  int guavaCacheMaxSize;

  @Setup
  public void setup() {
    System.setProperty("calcite.reflect.visit.dispatcher.method.cache.maxSize", String.valueOf(guavaCacheMaxSize));
  }

  @Benchmark
  public String testGlobalCachingUsingGuavaCache() {
  ...
  @Benchmark
  public String testGlobalCachingUsingHashMap() {
    ReflectUtilUsingHashMapReflectiveVisitorDispatcher.MethodDispatcher<String> dispatcher =
        ReflectUtilUsingHashMapReflectiveVisitorDispatcher.createMethodDispatcher(
            String.class, visitor, "say", String.class);
    String result = dispatcher.invoke("hello");
    return result;
  }
  ...
  public static void main(String[] args) throws RunnerException, NoSuchMethodException, IllegalAccessException {
    Options opt = new OptionsBuilder()
        .include(ReflectiveVisitDispatcherTest2.class.getSimpleName())
        .build();
